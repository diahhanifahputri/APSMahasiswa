        ...
        <div class="container">
            <div class="col-md-9">
                ...
                <form action="<?php echo site_url('crud/Update') ?>" method = "post">
                    ...
                    <div class = "form-group">
                        <label>Alamat</label>
                        <textarea name="alamat" rows="3" class="form-control"><?php echo $mahasiswa->alamat ?> </textarea>
                    </div>
                    ...
                    <div class = "form-group">
                        ...
                        <select name="NilaiIPK" class="form-control">
                            <?php foreach ($nilai as $n): ?>
                                <option value="<?php echo $n->id_nilai ?>" <?php if($n->id_nilai == $mahasiswa->id) echo 'selected'; ?>><?php echo $n->IPK ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
